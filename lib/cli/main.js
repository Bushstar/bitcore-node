...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `feathercore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ feathercore-node add wallet-service');
      console.log('    $ feathercore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ feathercore-node remove wallet-service');
      console.log('    $ feathercore-node remove insight-api');
      console.log();
    });
